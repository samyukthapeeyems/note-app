      ...
      <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            ...
            <input className="border-amber-800 border-opacity-10 bg-amber-800 bg-opacity-10 backdrop-blur-lg appearance-none border rounded-lg w-1/3 py-2 px-3 text-gray-700 font-bold leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Search by title"/>
